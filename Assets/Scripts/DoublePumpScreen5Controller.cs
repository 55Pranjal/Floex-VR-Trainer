...
/// <summary>
/// Diagnostics screen for the double pump head canvas. Firmware-confirmed minimal:
...
/// / "00:00:00" in Product A scope. If diagnostics-from-state becomes needed
/// later, wire SetText calls in OnEnable() from DoublePumpHeadState fields.
/// </summary>
public class DoublePumpScreen5Controller : MonoBehaviour
{
    [Header("Wiring")]
