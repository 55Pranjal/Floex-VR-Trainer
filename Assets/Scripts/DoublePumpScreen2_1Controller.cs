...
/// <summary>
/// Master-Slave configuration screen for the double pump head canvas.
/// 6 exclusive options (Nil=0, Arterial=1, Cardio=2, Vent=3, Suct1=4, Suct2=5)
/// plus a 0..200 flow spinner. Apply commits temps to DoublePumpHeadState and
/// navigates home. Cancel/nav-away discards.
/// </summary>
public class DoublePumpScreen2_1Controller : MonoBehaviour
{
    [Header("Wiring")]
