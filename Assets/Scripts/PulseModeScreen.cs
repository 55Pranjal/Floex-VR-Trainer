...
/// <summary>
/// Pulse Mode Configuration. 4 counters (PF/PW/BF/PFL, each 0..200 with wrap)
/// plus an on/off toggle for pulse mode. Apply commits to PumpHeadState; Cancel
/// reverts; nav-away discards pending temps.
/// </summary>
