...
/// <summary>
/// Fine Calibration screen. 3 counters (FC/Tube1/Tube2, each 0..200 with wrap)
/// plus an on/off toggle. Apply commits to PumpHeadState; Cancel reverts;
/// nav-away discards pending temps.
/// </summary>
